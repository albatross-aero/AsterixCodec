...
void CategoriesToFilter::setListOfCategoryAndDatasourcesInDecimalToFilter(
        vector<int> _listOfCategoryAndDatasourcesInDecimalToFilter) {
...
void from_json(const json &j, CategoriesToFilter &categories) {
    ...
    categories.setListOfCategoryAndDatasourcesInDecimalToFilter(
            j.at("listOfCategoryAndDatasourcesInDecimalToFilter").get<vector<int>>());
}