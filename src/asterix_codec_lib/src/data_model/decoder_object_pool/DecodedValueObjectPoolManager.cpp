...
DecodedValueObjectPoolManager::DecodedValueObjectPoolManager() {
    ...
    signedInteger8bitValueObjectPool = new ObjectPool<SignedInteger8bitValue>(this,
                                                                              common->getInteger8bitValuePoolSize());

    signedInteger16bitValueObjectPool = new ObjectPool<SignedInteger16bitValue>(this,
                                                                                common->getInteger16bitValuePoolSize());

    signedInteger32bitValueObjectPool = new ObjectPool<SignedInteger32bitValue>(this,
                                                                                common->getInteger32bitValuePoolSize());

    signedInteger64bitValueObjectPool = new ObjectPool<SignedInteger64bitValue>(this,
                                                                                common->getInteger64bitValuePoolSize());

    unsignedInteger8bitValueObjectPool = new ObjectPool<UnsignedInteger8bitValue>(this,
                                                                                  common->getInteger32bitValuePoolSize());

    unsignedInteger16bitValueObjectPool = new ObjectPool<UnsignedInteger16bitValue>(this,
                                                                                    common->getInteger32bitValuePoolSize());

    unsignedInteger32bitValueObjectPool = new ObjectPool<UnsignedInteger32bitValue>(this,
                                                                                    common->getInteger32bitValuePoolSize());

    unsignedInteger64bitValueObjectPool = new ObjectPool<UnsignedInteger64bitValue>(this,
                                                                                    common->getInteger64bitValuePoolSize());
