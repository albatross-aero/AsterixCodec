...
void CommonVariables::printCommonParameters() {
    cout << "\t\t debugEnabled: " << std::boolalpha << debugEnabledForDecoder << endl << "\t\t encodingDebugEnabled: " << std::boolalpha
         << debugEnabledForEncoder << endl
         << "\t\t debugObjectPoolEnabledConsumer: " << std::boolalpha
         << debugConsumerObjectPoolEnabled << endl << "\t\t debugObjectPoolEnabledProducer: " << std::boolalpha << debugProducerObjectPoolEnabled
         << endl
