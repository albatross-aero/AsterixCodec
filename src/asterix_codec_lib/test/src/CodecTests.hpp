...
protected:
    ...
    void categoriesDescriptionLoadingAndFSPECreation(unsigned short int *bufferIndex, unsigned short int *bytesRead,
                                                     unsigned short int datablockCategoryNumber,
    ...
    void skipAllParsing(unsigned short int bufferIndex, unsigned short int datablockCategoryNumber, int FRN,
                        int alreadyParsedBytes) {
        ...
        categoriesDescriptionLoadingAndFSPECreation((unsigned short int *) (&bufferIndex), &bytesRead,
                                                    datablockCategoryNumber, &categoryDescription,
        ...
        switch (itemToParse->getItemType()) {
            case ItemTypeEnum::FixedLength:
                ParsingUtils::parseFixedLengthItem(ASTERIX_datastream, itemToParse, bufferIndex + bytesRead, true,
                                                   parsedElementsOP);
                break;
            case ItemTypeEnum::ExtendedLength:
                ParsingUtils::parseExtendedLengthItem(ASTERIX_datastream, itemToParse, bufferIndex + bytesRead, true,
                                                      parsedElementsOP);
                break;
            case ItemTypeEnum::RepetitiveLength:
                ParsingUtils::parseRepetitiveLengthItem(ASTERIX_datastream, itemToParse, bufferIndex + bytesRead, true,
                                                        parsedElementsOP);
                break;
            case ItemTypeEnum::CompoundLength:
                ParsingUtils::parseCompoundLengthItem(ASTERIX_datastream, itemToParse, bufferIndex + bytesRead, true,
                                                      compoundSubItemsDescription,
                                                      datablockCategoryNumber, parsedElementsOP);
                break;
            case ItemTypeEnum::ExplicitLength:
                ParsingUtils::parseExplicitLengthItem(ASTERIX_datastream, itemToParse, bufferIndex + bytesRead, true,
                                                      refItemDescription,
