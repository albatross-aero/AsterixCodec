...
//	Range validRange = Range(0, 255);
    ...
    // SAC
    decodedSAC = DecodingUtils::toDecimal(&(bytestream[0]), &valueLengthInBit, &multiplicationFactor,
                                          &representationModeForDecoding, &validRange,
    ...
    // SIC
    decodedSIC = DecodingUtils::toDecimal(&(bytestream[1]), &valueLengthInBit, &multiplicationFactor,
                                          &representationModeForDecoding, &validRange,
...
TEST_F(CodecTest, DecodesToHexadecimal) {
    ...
    // Target Address
    decodedTargetAddress = DecodingUtils::toHexadecimal(bytestream, &valueLengthInBit, &multiplicationFactor,
...
TEST_F(CodecTest, DecodesCA2ToDecimal) {
    ...
    // Latitude
    decodedLatitude = DecodingUtils::toDecimal(&(bytestream[0]), &valueLengthInBit, &multiplicationFactor,
                                               &representationModeForDecoding,
                                               &validRange,
                                               (unsigned int) 21,
    ...
    // Longitude
    decodedLongitude = DecodingUtils::toDecimal(&(bytestream[3]), &valueLengthInBit, &multiplicationFactor,
                                                &representationModeForDecoding,
                                                &validRange,
                                                (unsigned int) 21,
...
TEST_F(CodecTest, DecodesToOctal) {
    ...
    // Mode3A
    decodedMode3A = DecodingUtils::toOctal(bytestream, &valueLengthInBit, &multiplicationFactor,
                                           &representationModeForDecoding, &range,
                                           (unsigned int) 21,
...
TEST_F(CodecTest, DecodesToTargetId) {
    ...
    // TargetID
    decodedTargetId = DecodingUtils::toTargetId(bytestream, &valueLengthInBit, &multiplicationFactor,
                                                &representationModeForDecoding,
                                                (unsigned int) 21,
                                                &elementName, decodedElementsOP);
...
TEST_F(CodecTest, DecodesToASCII) {
    ...
    // FPL-Callsign
    decodedFPLCallsign = DecodingUtils::toAscii(bytestream, &valueLengthInBit, &multiplicationFactor,
                                                &representationModeForDecoding,
                                                (unsigned int) 62,
                                                &elementName, decodedElementsOP);
...
TEST_F(CodecTest, DecodesToMBData) {
    ...
    // MBData
    decodedMBData = DecodingUtils::toMBData(bytestream, &valueLengthInBit, &multiplicationFactor,
                                            &representationModeForDecoding, (unsigned int) 21,
                                            &elementName, decodedElementsOP);
