...
TEST_F(CodecTest, DatablockCategoryIdentification) {
    vector<unsigned char> ASTERIX_StdCivilMilitaryAppCategories = {0x00, 0x01, 0x02, 0x03, 0x04, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x11,
                                                                   0x12,
                                                                   0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1f, 0x20, 0x21, 0x22, 0x30, 0x3d, 0x3e,
                                                                   0x3f, 0x41};
    ...
    vector<unsigned char> ASTERIX_NoStdCivilMilitaryAppCategories = {0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd,
                                                                     0xfe, 0xff};
...
//	EXPECT_EQ(ASTERIX_NoStdCivilMilitaryAppCategories.size(), 15);
    ...
    ASSERT_NE(std::find(ASTERIX_Categories.begin(), ASTERIX_Categories.end(), ASTERIX_datastream[0]), ASTERIX_Categories.end())
...
TEST_F(CodecTest, ParsesFixedLengthItem) {
    ...
    categoriesDescriptionLoadingAndFSPECreation(&bufferIndex, &bytesRead, (unsigned short int) 21, &categoryDescription, &itemsDescription,
                                                &FRN_list);
...
TEST_F(CodecTest, ParsesSpfItem) {
    ...
    categoriesDescriptionLoadingAndFSPECreation(&bufferIndex, &bytesRead, (unsigned short int) 62, &categoryDescription, &itemsDescription,
                                                &FRN_list);
