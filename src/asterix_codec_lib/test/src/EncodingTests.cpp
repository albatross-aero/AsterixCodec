...
TEST_F(CodecTest, EncodesDecimal) {
    ...
    UnsignedInteger8bitValue *sacToEncode = new UnsignedInteger8bitValue(decodedElementsOP, 50,
                                                                         RepresentationModeEnum::Unsigned8bitIntegerValue);
...
//	Range validRange = Range(-90, 90);
    ...
    encodedLatitude = ElementEncodingUtils::encodeDecimalToCA2(latitudeToEncode, &validRange, 24, 0.00002145767,
                                                               &elementName, (unsigned int) 21);
