...
public:
    ...
    encodeREFItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues, Item *itemToEncode,
     ...
     */
    static std::vector<unsigned char> *
    encodeSPFItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues, Item *itemToEncode,
