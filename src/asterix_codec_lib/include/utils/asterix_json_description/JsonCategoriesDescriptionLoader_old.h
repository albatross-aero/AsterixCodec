...
public:
     ...
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
    static void composeCategoriesDescriptionMapFromJsonFiles(AsterixConfiguration currentAsterixConfiguration, string astConfigurationFilePath,
     ...
     */
    static void
    loadItemsDescription(string astConfigurationFilePath, string itemsDescriptionPath, ExternalCategoryDescription &extCategoryDescription,
                         ReturnStatus *status);
     ...
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
    static void setFiltersForAllCategoriesDescription(bool isLookingCatNumber, FilterTypeEnum decoderFilterType, FilterTypeEnum encoderFilterType,
     ...
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
    static void checkAndSetFiltersForCategoryDescription(string filterPath, CategoryItemsFilter categoryItemsFilters,
                                                         CategoryDescription *categoryDescription, ReturnStatus *status);
     ...
     */
    static void
    setFiltersForVectorOfItems(FilterTypeEnum decoderFilterType, FilterTypeEnum encoderFilterType, std::vector<std::string> *decoderFilterList,
