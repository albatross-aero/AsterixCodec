...
public:
    ...
    parseDatablock(unsigned char *ASTERIX_datablock, unsigned short int datablockCategory, int datablockLength,
     ...
     */
    static int
    parseAllRecords(unsigned char *ASTERIX_datablock, int bufferIndex, int datablockCategory, int datablockLength,
     ...
     */
    static int
    parseFixedLengthItem(unsigned char *ASTERIX_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
     ...
     */
    static int
    parseExtendedLengthItem(unsigned char *ASTERIX_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                            ParsedRecord *objectPool);
     ...
     */
    static int
    parseRepetitiveLengthItem(unsigned char *ASTERIX_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                              ParsedRecord *objectPool);
     ...
     */
    static int
    parseCompoundLengthItem(unsigned char *ASTERIX_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
     ...
     */
    static int
    parseExplicitLengthItem(unsigned char *ASTERIX_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
