    ...
    for (auto el : _elements) {
        ...
        switch (representationModeEnum) {
            case RepresentationModeEnum::Unsigned8bitIntegerValue:
                elementValue = new UnsignedInteger8bitValue(nullptr, (uint8_t) atoi(elementValueInString),
                                                            representationModeEnum);
                break;
            case RepresentationModeEnum::Unsigned16bitIntegerValue:
                elementValue = new UnsignedInteger16bitValue(nullptr, (uint16_t) atoi(elementValueInString),
                                                             representationModeEnum);
                break;
            case RepresentationModeEnum::Unsigned32bitIntegerValue:
                elementValue = new UnsignedInteger32bitValue(nullptr, (uint32_t) atoi(elementValueInString),
                                                             representationModeEnum);
                break;
            case RepresentationModeEnum::Unsigned64bitIntegerValue:
                elementValue = new UnsignedInteger64bitValue(nullptr, (uint64_t) stoi(elementValueInString),
                                                             representationModeEnum);
                break;
            case RepresentationModeEnum::Signed8bitIntegerValue:
                elementValue = new SignedInteger8bitValue(nullptr, (int8_t) stoi(elementValueInString),
                                                          representationModeEnum);
                break;
            case RepresentationModeEnum::Signed16bitIntegerValue:
                elementValue = new SignedInteger16bitValue(nullptr, (int16_t) stoi(elementValueInString),
                                                           representationModeEnum);
                break;
            case RepresentationModeEnum::Signed32bitIntegerValue:
                elementValue = new SignedInteger32bitValue(nullptr, (int32_t) stoi(elementValueInString),
                                                           representationModeEnum);
                break;
            case RepresentationModeEnum::Signed64bitIntegerValue:
                elementValue = new SignedInteger64bitValue(nullptr, (int64_t) stoi(elementValueInString),
                                                           representationModeEnum);
                break;
