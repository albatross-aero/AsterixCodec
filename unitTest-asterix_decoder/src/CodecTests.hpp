...
class CodecTest: public ::testing::Test {
	protected:
		CodecTest() {
			ASTERIX_inputFilePath = "asterix/ASTbinaries/forTest_cat21ed24_cat62ed117withSPF-edited.ast";
		...
		void categoriesDescriptionLoadingAndFSPECreation(unsigned short int *bufferIndex, unsigned short int *bytesRead,
				unsigned short int datablockCategoryNumber, CategoryDescription** categoryDescription, vector<Item> **itemCollection, vector<int> *FRN_list) {
