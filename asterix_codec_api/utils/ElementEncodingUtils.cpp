#include "ElementEncodingUtils.h"
...
void ElementEncodingUtils::checkValidityRange(string *elementName, double elementValue, Range* elementRange, unsigned int categoryNumber) {
	...
	if (isInsideRange == false) {
		...
		string message = "Out of range Element value '" + (*elementName) + "': it is " + to_string(elementValue) + ", but it was expected to be between "
...
unsigned char* ElementEncodingUtils::encodeDecimal(ElementValue* element, Range *validityRange, int lengthInBit, double multFactor, string *elementName,
...
unsigned char* ElementEncodingUtils::encodeDecimalToCA2(ElementValue* element, Range *validityRange, int lengthInBit, double multFactor, string *elementName,
		unsigned int categoryNumber) {
