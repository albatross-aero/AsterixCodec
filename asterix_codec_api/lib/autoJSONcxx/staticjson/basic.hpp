...
public:
    ...
    virtual bool Int64(int64_t) override { return set_type_mismatch("int64_t"); }

    virtual bool Uint64(uint64_t) override { return set_type_mismatch("uint64_t"); }
...
public:
    ...
    virtual bool Int64(int64_t) override;

    virtual bool Uint64(uint64_t) override;
