...
unsigned int ParsedRecord::getRawRecordLength() {
	return rawRecordLength;
}

void ParsedRecord::setRawRecordLength(unsigned int _lengthRawRecord) {
	rawRecordLength = _lengthRawRecord;
}

unsigned int ParsedRecord::getRecordCategoryNumber() {
	return recordCategoryNumber;
}

void ParsedRecord::setRecordCategoryNumber(unsigned int _recordCategoryNumber) {
	recordCategoryNumber = _recordCategoryNumber;
}

unsigned int ParsedRecord::getObjectPoolCurrentSize() {
