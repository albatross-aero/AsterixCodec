...
#include "lib/boost/serialization/map.hpp"
...
public:
	...
	CategoryDescription(std::vector<Item> _itemsDescription, std::vector<Item> _compoundSubItemsDescription, std::vector<Item> _refItemDescription,
			std::vector<Item> _spfItemDescription);
	 ...
	 */
	std::vector<Item>* getItemCollection();
	 ...
	 */
	void setItemCollection(std::vector<Item> _itemsDescription);

	/**
	 * Returns a pointer to the vector of Item instances, describing an ASTERIX Category.
	 * @return a vector<Item>* holding the collection of Compound Subitems of an ASTERIX Category
	 */
	std::vector<Item>* getCompoundSubItemsDescription();
	 ...
	 */
	void setCompoundSubItemsDescription(std::vector<Item> _compoundSubItemsDescription);

	/**
	 * Returns a pointer to the vector of Item instances, describing an ASTERIX Category.
	 * @return a vector<Item>* holding the Reserved Expansion Field (REF) Item collection of an ASTERIX Category
	 */
	std::vector<Item>* getRefItemDescription();
	 ...
	 */
	void setRefItemDescription(std::vector<Item> _reItemDescription);
	 ...
	 */
	std::vector<Item>* getSpfItemDescription();
	 ...
	 */
	void setSpfItemDescription(std::vector<Item> _spfItemDescription);
