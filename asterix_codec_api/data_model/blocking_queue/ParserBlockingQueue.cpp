...
ParserBlockingQueue::ParserBlockingQueue(unsigned int _dimensionBlockingQueue, unsigned int elementObjectPoolSize, unsigned int membershipQueue) {
...
void ParserBlockingQueue::setObjectPoolInQueue(unsigned int threadId, ParsedRecord* objectPool) {
	unique_lock<std::mutex> uniqueLock(queueMutex);
