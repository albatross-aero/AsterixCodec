...
RecordCollection::RecordCollection() {
	...
	collectionOfRecordCategoryNumber = new vector<unsigned int>();
}
...
// CATEGORY NUMBER
vector<unsigned int>* RecordCollection::getCollectionOfRecordCategoryNumber() {
	return collectionOfRecordCategoryNumber;
}

void RecordCollection::setCollectionOfRecordCategoryNumber(vector<unsigned int>* _collectionOfRecordCategoryNumber) {
	collectionOfRecordCategoryNumber = _collectionOfRecordCategoryNumber;
}

unsigned int RecordCollection::getCategoryNumberOfARecord(unsigned int recordNumber) {
...
void RecordCollection::addRecordsInCollection(RecordCollection* recordsToAdd) {
	...
	vector<unsigned int>* otherCollectionOfRecordCategoryNumber = recordsToAdd->getCollectionOfRecordCategoryNumber();
