...
public:
	 ...
	 */
	vector<unsigned int>* getCollectionOfRecordCategoryNumber();
	 ...
	 */
	void setCollectionOfRecordCategoryNumber(vector<unsigned int>*_collectionOfRecordCategoryNumber);
	 ...
	 */
	unsigned int getCategoryNumberOfARecord(unsigned int recordNumber);
...
private:
	 ...
	 */
	vector<unsigned int>* collectionOfRawRecordLength;    // this class is not responsible for the deallocation of the unsigned char*

	/**
	 * Collection of Record number.
	 */
	vector<unsigned int>* collectionOfRecordCategoryNumber;    // this class is not responsible for the deallocation of the unsigned char*
};
