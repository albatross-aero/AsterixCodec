...
void FacadeCommonVariables::printCommonParameters() {
	...
	std::cout << "\t\t filter_decodingEnabled: " << std::boolalpha << filter_decodingEnabled << endl << "\t\t filter_encodingEnabled: " << std::boolalpha
			<< filter_encodingEnabled << endl << "\t\t REF_decodingEnabled: " << std::boolalpha
			<< REF_decodingEnabled << endl << "\t\t SPF_decodingEnabled: " << std::boolalpha
			<< SPF_decodingEnabled << endl << "\t\t REF_encodingEnabled: " << std::boolalpha << REF_encodingEnabled << endl << "\t\t SPF_encodingEnabled: "
			<< std::boolalpha << SPF_encodingEnabled << endl << "\t\t jsonOutputEnableForDecoder: " << std::boolalpha << jsonOutputEnableForDecoder << endl
			...
			<< numberOfProducerThreads << endl << "\t\t numberOfConsumerThreads: " << numberOfConsumerThreads << endl << "\t\t numberOfEncoderThreads: "
