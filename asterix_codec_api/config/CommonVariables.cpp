...
CommonVariables::CommonVariables() {
	...
	sacSicItem->setAllFunctionNamesInEnumForDecoding(vector<FunctionNameEnum> { FunctionNameEnum::toDecimal, FunctionNameEnum::toDecimal });
	...
	sacSicItem->setAllRepresentationModesInEnumForDecoding(vector<RepresentationModeEnum> { RepresentationModeEnum::IntegerValue,
...
void CommonVariables::printCommonParameters() {
	cout << "\t\t debugEnabled: " << std::boolalpha << debugEnabledForDecoder << endl << "\t\t encodingDebugEnabled: " << std::boolalpha << debugEnabledForEncoder << endl
			<< "\t\t debugObjectPoolEnabledConsumer: " << std::boolalpha
			<< debugConsumerObjectPoolEnabled << endl << "\t\t debugObjectPoolEnabledProducer: " << std::boolalpha << debugProducerObjectPoolEnabled << endl
